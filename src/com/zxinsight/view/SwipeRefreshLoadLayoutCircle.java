 ...
 * </p>
 */
public class SwipeRefreshLoadLayoutCircle extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = MaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = SwipeRefreshLoadLayoutCircle.class.getSimpleName();
    ...
    private static final int DEFAULT_CIRCLE_TARGET_END = 8;

    private View mTarget; // the target of the gesture
    private OnRefreshListener mListener;
//    private OnLoadingListener mLoadingListener;
    private boolean mRefreshing = false;
    private boolean mLoading = false;   //aaron
    ...
    private void setProgressView() {
        ...
        mOriginalOffsetTop = mCurrentTargetOffsetTop = (int)mSpinnerFinalOffset;
        mUsingCustomStart = true;
        mCircleView.invalidate();
    }
    private void setProgressViewBottom() {
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        mSpinnerFinalOffset = metrics.heightPixels-DEFAULT_CIRCLE_TARGET* metrics.density;
        mOriginalOffsetTop = mCurrentTargetOffsetTop = (int) ((int)metrics.heightPixels-DEFAULT_CIRCLE_TARGET_END* metrics.density);
        mUsingCustomStart = true;
        mCircleView.invalidate();
    }
    ...
    /**
     * Simple constructor to use when creating a SwipeRefreshAndLoadLayout from code.
     *
     * @param context
     */
    public SwipeRefreshLoadLayoutCircle(Context context) {
        this(context, null);
    }

    /**
     * Constructor that is called when inflating SwipeRefreshAndLoadLayout from XML.
     *
     * @param context
     * @param attrs
     */
    public SwipeRefreshLoadLayoutCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        if (!isEnabled() || mReturningToStart || canChildScrollUp() || canChildScrollDown() || mRefreshing || mLoading) {
